...
def load_config(path: Path) -> AppConfig:
    ...
    filtering = _load_filtering(
        filtering_raw,
        {
            ...
            "headline_max_input_tokens": None,
            "headline_max_new_tokens": None,
            "headline_single_replay_max_new_tokens": None,
    ...
    return AppConfig(
        ...
        enrichment=EnrichmentConfig(
            ...
            max_context_chars_per_article=int(enrichment_raw.get("max_context_chars_per_article", 1600)),
        ),
