...
class FilteringConfig:
    ...
    max_headlines_per_source: int = 16
...
class AppConfig:
    ...
    general_filtering: FilteringConfig = field(default_factory=default_general_filtering_config)
...
@dataclass
class ProfileMatchAnnotation:
    source_preferred: bool = False
    source_avoided: bool = False
    geo_match: bool = False
    wants_match_count: int = 0
    avoid_match_count: int = 0
    beat_weight_sum: float = 0.0
    geo_matches: List[str] = field(default_factory=list)
    wants_matches: List[str] = field(default_factory=list)
    avoid_matches: List[str] = field(default_factory=list)
    beat_matches: List[str] = field(default_factory=list)
